...
# =========================
model = YOLO("yolov8_traffic.trt")  # or yolov8_traffic.pt if no TensorRT

# Match EXACT class list from PDF
model.names = {
    0: "Car",
    1: "Bus",
    2: "Truck",
...
# Video IO
# =========================
input_video = "/mnt/data/Supporting video for Dataset-2.mp4"
